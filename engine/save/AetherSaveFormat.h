...
#define AETHER_SAVE_HEADER_SIZE  64
...
typedef struct aether_save_header {
    ...
    u32   flags;
    u32   entity_count;
    u32   checksum;                         /* simple XOR-fold */
    u8    reserved[AETHER_SAVE_HEADER_SIZE - 4*7 - AETHER_SAVE_MAP_NAME_MAX - AETHER_SAVE_GAME_NAME_MAX];
