/* AetherRender.h — Renderer abstraction layer. Multiple backends possible.
 * iOS backend: Metal (implemented in Swift via AetherRenderBridge callbacks).
 */
...
aether_result_t     aether_renderer_begin_frame(aether_renderer_t *r, f32 r, f32 g, f32 b, f32 a);
