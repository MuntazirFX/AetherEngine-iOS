...
(synthetic X=0 split + marksurfaces; `vis_offset=-1` → all empty leaves visible), clipnode hulls for walk/slide/ground/step-up (player stays on floor, climbs ≤18u ledges), and red monster debug boxes from the entity/monster registries.
...
- `AetherCollision` — clipnode hull point-in-solid + axis move-and-slide + Quake step-up (synthetic room + 16u ledge)
