...
info "batch hiz-gpu-mipchain / portal-pvs / studio-skin-lump / ipa-device-run"
grep -q "aether_depth_hiz_mtk_mipchain_plan\|aether_depth_hiz_mtk_mipchain_complete\|aether_mdl_hiz_gpu_mipchain_after_mtk" engine/render/AetherDepthPrepass.h engine/model/AetherModelFixture.h || fail "missing Hi-Z GPU mipchain after MTK"
grep -q "aether_mdl_hiz_gpu_mipchain_after_mtk\|aether_mdl_hiz_vis_query_mipchain\|aether_mdl_hiz_gpu_mipchain_ready" engine/model/AetherModelFixture.h || fail "missing Hi-Z mipchain query"
grep -q "aether_bsp_portal_pvs_flood\|aether_bsp_portal_pvs_flood_fixture\|aether_bsp_portal_pvs_leaf_visible\|aether_water_reflect_portal_pvs_plan" engine/bsp/AetherBSPVis.h engine/render/AetherWater.h || fail "missing portal×PVS flood"
grep -q "aether_mdl_skin_lump_metal_families_fixture\|aether_mdl_skin_lump_metal_families_from_lumps\|aether_mdl_skin_lump_metal_bind_was_bound" engine/model/AetherModelFixture.h || fail "missing skin-lump Metal families"
grep -q "DEVICE_RUN\|first launch\|entitlements\|Documents.*game\|Documents/AetherEngine\|game dir" build/scripts/package_ipa.sh README.md || fail "missing device-run notes"
grep -q "aether_hiz_gpu_mipchain\|aether_portal_pvs_flood_fragment\|aether_mdl_skin_lump_metal_family_fragment\|aether_depth_hiz_mtk_mipchain_fragment" ios/AetherApp/Shaders.metal || fail "missing Metal mipchain/portal-pvs/skin-lump hooks"
grep -q "engine_depth_hiz_mtk_mipchain_plan\|engine_mdl_hiz_gpu_mipchain_after_mtk\|engine_bsp_portal_pvs_flood_fixture\|engine_mdl_skin_lump_metal_families_fixture\|engine_water_reflect_portal_pvs_plan" ios/AetherApp/EngineBridge.h || fail "missing bridge batch20"
grep -q "encodeHizGpuMipchainAfterMtk\|ensureSkinLumpMetalFamilyAtlas\|engine_mdl_hiz_gpu_mipchain_after_mtk\|engine_bsp_portal_pvs_flood_fixture\|engine_mdl_skin_lump_metal" ios/AetherApp/MetalRenderer.swift || fail "missing metal batch20 encode"
grep -q "hiz-gpu-mipchain\|portal-pvs\|studio-skin-lump\|~82%" README.md || fail "missing batch20 README"
grep -q "smoke_batch_hiz_gpu_mipchain_portal_pvs_studio_skin_lump_ipa_device_run" tests/host_smoke.c || fail "missing batch20 smoke"
ok "batch hiz-gpu-mipchain/portal-pvs/studio-skin-lump/ipa-device-run API symbols present"

info "batch hiz-occlusion-lod / pvs-decode / fs-documents / ipa-device-smoke"
grep -q "aether_mdl_hiz_occlusion_feedback_from_mipchain\|aether_mdl_lod_hiz_occlusion_gate\|aether_mdl_lod_gpu_issue_draw_hiz_occlusion" engine/model/AetherModelFixture.h || fail "missing Hi-Z occlusion→LOD gate"
grep -q "aether_depth_hiz_occlusion_feedback_plan_encode\|aether_depth_hiz_occlusion_feedback_plan_ready" engine/render/AetherDepthPrepass.h || fail "missing depth occlusion feedback plan"
grep -q "aether_bsp_vis_decode_pvs_row\|aether_bsp_vis_decode_fixture\|aether_bsp_vis_decode_for_leaf\|aether_bsp_vis_decode_leaf_visible" engine/bsp/AetherBSPVis.h || fail "missing PVS row decode"
grep -q "aether_fs_mount_documents_gamedir\|aether_fs_ensure_documents_layout\|aether_fs_documents_write_marker\|AETHER_FS_DOCUMENTS_ENGINE_DIR" engine/fs/AetherFS.h || fail "missing Documents gamedir FS mount"
grep -q "DEVICE_SMOKE_CHECKLIST\|hiz_lod\|user_bsp_pvs\|Actions artifact" build/scripts/package_ipa.sh README.md || fail "missing device smoke checklist polish"
grep -q "aether_hiz_occlusion_lod_feedback_fragment\|aether_bsp_vis_pvs_decode_fragment\|aether_fs_documents_gamedir_fragment\|aether_depth_hiz_occlusion_feedback_fragment" ios/AetherApp/Shaders.metal || fail "missing Metal occlusion/PVS/FS hooks"
grep -q "engine_mdl_lod_hiz_occlusion_gate\|engine_bsp_vis_decode_fixture\|engine_fs_mount_documents_gamedir\|engine_mdl_hiz_occlusion_feedback" ios/AetherApp/EngineBridge.h || fail "missing bridge batch21"
grep -q "applyHizOcclusionLodFeedback\|engine_mdl_lod_hiz_occlusion_gate\|engine_bsp_vis_decode_fixture\|engine_depth_hiz_occlusion_feedback_plan" ios/AetherApp/MetalRenderer.swift || fail "missing metal batch21 encode"
grep -q "hiz-occlusion\|pvs-decode\|fs-documents\|~83%" README.md || fail "missing batch21 README"
grep -q "smoke_batch_hiz_occlusion_lod_pvs_fs_ipa_device" tests/host_smoke.c || fail "missing batch21 smoke"
ok "batch hiz-occlusion-lod/pvs-decode/fs-documents/ipa-device-smoke API symbols present"
